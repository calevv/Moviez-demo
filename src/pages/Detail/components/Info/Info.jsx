                ...
                <AccordionDetails>
                    <Typography component="div">
                        {detailData?.genres.length !== 0
                            ? showGenre(detailData?.genres).map((item, index) => <Button key={index}>{item}</Button>)
                        ...
                        <Typography component="div">
                            {castList.length !== 0 ? (
                                castList.length > 5 ? (
                                    ...
                                    castList.map((actor) => <Button key={actor.id}>{actor.name}</Button>)
                                )
                            ) : (
                        ...
                        <Typography component="div">
                            {crewList.length !== 0 ? (
                                crewList.length > 5 ? (
                                    ...
                                    crewList.map((crew) => <Button key={crew.id}>{crew.name}</Button>)
                                )
                            ) : (
